...
export default function AvatarPage() {
  return (
    <PageContainer>
      <PageHeader
        title="Avatar"
        description="Avatar component examples with different sizes and status indicators"
      />
      <div className="space-y-5 sm:space-y-6">
        <ContentCard title="Default Avatar">
        ...
        <ContentCard title="Avatar with online indicator">
          <div className="flex flex-col items-center justify-center gap-5 sm:flex-row">
            <Avatar
        ...
        <ContentCard title="Avatar with Offline indicator">
          <div className="flex flex-col items-center justify-center gap-5 sm:flex-row">
            <Avatar
              src="/images/user/user-01.jpg"
              size="xsmall"
        ...
        <ContentCard title="Avatar with busy indicator">
          <div className="flex flex-col items-center justify-center gap-5 sm:flex-row">
            <Avatar
              src="/images/user/user-01.jpg"
              size="xsmall"
