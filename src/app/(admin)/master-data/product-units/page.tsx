...
function PageContent() {
  ...
  const confirmDelete = async () => {
    if (!deleteId) return;
    try {
      const response = await apiFetch(`/masters/products/units/${deleteId}`, { method: "DELETE" });
      if (response.ok) {
    ...
    <PageContainer>
      ...
      <ContentCard>
        <DataTable
          columns={columns}
          data={data}
          emptyMessage="ไม่พบข้อมูลหน่วยผลิตภัณฑ์"
          rowKey="id"
        />
      </ContentCard>
      ...
      <ConfirmModal
        ...
        type="delete"
        message="คุณต้องการลบหน่วยผลิตภัณฑ์รายการนี้หรือไม่?"
      />
    </PageContainer>
  );
}
